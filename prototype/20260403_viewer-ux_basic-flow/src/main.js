...
const CATEGORIES = [
  ...
  { id: 'soup-base', brandId: 'ramen', name: 'スープ仕込み', slug: 'soup-base', description: 'スープ（魚骨・鶏白湯・昆布）の仕込み手順', icon: '🫕', movieCount: 1 },
...
const MOVIES = [
  ...
  },
  {
    ...
    title: '魚骨スープ仕込み（12時間炊き）',
    description: '白濁した魚骨スープを12時間かけて炊き上げる手順。骨の下処理から完成まで。',
    totalSteps: 6,
    estimatedMinutes: 45,
    difficulty: 'advanced',
    tags: ['魚骨', 'スープ', '白濁', '長時間炊き'],
  },
];
  ...
  'tonkotsu-soup': [
    {
      ...
      durationSeconds: 180,
      description: '魚骨を冷水に一晩浸けて血抜きします。翌日、沸騰したお湯で5分間下茹でし、出てきたアクを捨てます。骨を流水でよく洗ってください。',
