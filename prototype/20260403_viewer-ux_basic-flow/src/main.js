...
const SEQUENCES = {
  'eel-fillet': [
    {
      stepNumber: 1, title: 'ステップ1: 道具の準備と衛生確認', videoId: 'PLACEHOLDER_STEP1',
      durationSeconds: 90,
    ...
    {
      stepNumber: 2, title: 'ステップ2: 目打ちで頭を固定する', videoId: 'PLACEHOLDER_STEP2',
      durationSeconds: 120,
    ...
    {
      stepNumber: 3, title: 'ステップ3: 背びれに沿って包丁を入れる（関東開き）', videoId: 'PLACEHOLDER_STEP3',
      durationSeconds: 180,
    ...
    {
      stepNumber: 4, title: 'ステップ4: 内臓の取り除き', videoId: 'PLACEHOLDER_STEP4',
      durationSeconds: 150,
    ...
    {
      stepNumber: 5, title: 'ステップ5: 骨取りと仕上げ', videoId: 'PLACEHOLDER_STEP5',
      durationSeconds: 200,
  ...
  'eel-stunning': [
    {
      stepNumber: 1, title: 'ステップ1: 活魚の確認と準備', videoId: 'PLACEHOLDER_STUNNING_S1',
      durationSeconds: 60,
    ...
    {
      stepNumber: 2, title: 'ステップ2: 目打ちによる締め', videoId: 'PLACEHOLDER_STUNNING_S2',
      durationSeconds: 90,
    ...
    {
      stepNumber: 3, title: 'ステップ3: 頭を落として捌き作業へ引き渡し', videoId: 'PLACEHOLDER_STUNNING_S3',
      durationSeconds: 60,
  ...
  'secret-tare': [
    {
      stepNumber: 1, title: 'ステップ1: 材料の計量と確認', videoId: 'PLACEHOLDER_TARE_S1',
      durationSeconds: 120,
    ...
    {
      stepNumber: 2, title: 'ステップ2: 合わせて火にかける', videoId: 'PLACEHOLDER_TARE_S2',
      durationSeconds: 240,
    ...
    {
      stepNumber: 3, title: 'ステップ3: 継ぎ足しタレへの合流', videoId: 'PLACEHOLDER_TARE_S3',
      durationSeconds: 90,
    ...
    {
      stepNumber: 4, title: 'ステップ4: 品質確認と記録', videoId: 'PLACEHOLDER_TARE_S4',
      durationSeconds: 90,
  ...
  'tonkotsu-soup': [
    {
      stepNumber: 1, title: 'ステップ1: 骨の下処理（血抜き・下茹で）', videoId: 'PLACEHOLDER_TONKOTSU_S1',
      durationSeconds: 180,
    ...
    {
      stepNumber: 2, title: 'ステップ2: 強火で白濁させる（最初の1時間）', videoId: 'PLACEHOLDER_TONKOTSU_S2',
      durationSeconds: 300,
    ...
    {
      stepNumber: 3, title: 'ステップ3: 中火で煮込む（〜12時間）', videoId: 'PLACEHOLDER_TONKOTSU_S3',
      durationSeconds: 240,
    ...
    {
      stepNumber: 4, title: 'ステップ4: 仕上げ調味', videoId: 'PLACEHOLDER_TONKOTSU_S4',
      durationSeconds: 120,
...
window.AppUtils = { getParam, escHtml, difficultyLabel, formatDuration, buildNavbar };
